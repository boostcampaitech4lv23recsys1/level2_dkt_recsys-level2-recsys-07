...
def process_batch(batch):
    ...
    test, question, tag, assessmentItemID_mean_answerCode, solving_time, correct, mask = batch
    ...
    solving_time = ((solving_time + 1) * mask)
    return (test, question, tag, assessmentItemID_mean_answerCode, solving_time, correct, mask, interaction)
