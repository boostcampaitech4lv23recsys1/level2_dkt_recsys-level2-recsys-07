...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        default="/opt/ml/new/level2_dkt_recsys-level2-recsys-07/data",
        type=str,
        help="data directory",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir", default="/opt/ml/new/level2_dkt_recsys-level2-recsys-07/code/dkt/output/", type=str, help="output directory"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--max_seq_len", default=10, type=int, help="max sequence length"
    )
    parser.add_argument("--num_workers", default=2, type=int, help="number of workers")

    # 모델
    parser.add_argument(
        "--hidden_dim", default=2, type=int, help="hidden dimension size"
    )
