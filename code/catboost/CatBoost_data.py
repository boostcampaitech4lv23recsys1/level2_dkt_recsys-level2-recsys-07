...
def cat_data_load(args):
    ...
    ######################## DATA LOAD
    train = pd.read_csv(args.DATA_PATH + 'train_data.csv', parse_dates=['Timestamp'])
    test = pd.read_csv(args.DATA_PATH + 'test_data.csv', parse_dates=['Timestamp'])
    ...
    train = train.drop(['test_time_mean','left_asymptote','test_time_sum','test_time_median','suffix',
    'prefix_ans_std','prefix_ans_sum','test_time_std',
    'testId','Timestamp','KnowledgeTag','user_cum_cnt','user_mean'],axis=1)
    # 'prefix','elo_prob',
    # 'assessmentItemID','user_acc','test_ans_std','testId',
    # 'reset_time','test_solve_time','tag_ans_std'
    # 'assess_relatvie_time','user_cum_correct',
    # 'prefix_time_sum',
    # 'user_cum_cnt',
    # 'tag_ans_sum',
    # 'test_ans_sum'
    ...
    test = test.drop(['answerCode','left_asymptote','test_time_mean','test_time_sum','test_time_median','suffix',
    'prefix_ans_std','prefix_ans_sum','test_time_std',
    'testId','Timestamp','KnowledgeTag','user_cum_cnt','user_mean'],axis=1)
    # 'prefix','elo_prob',
    # 'assessmentItemID','user_acc','test_ans_std','testId',
    # 'reset_time','test_solve_time','tag_ans_std',
    # 'assess_relatvie_time','user_cum_correct',
    # 'prefix_time_sum','assess_time_sum',
    # 'user_cum_cnt',
    # 'tag_ans_sum',
    # 'test_ans_sum'
    # ],axis=1)
...
def feature_engineering(df):
    ...
    df["reset_time"] = np.log1p(time_df["reset_time"])#.apply(lambda x: math.log(x + 1))
